...
@dataclass
class GradualLearningExperimentTemplateParams(ParamsBase):
...
class GradualLearningExperimentComponent(ExperimentComponent):
    """
...
class GradualLearningExperimentTemplate(ExperimentTemplateBase[Union[GradualLearningTopology, TrainTestSwitchable]]):
    def __init__(self, template_params: GradualLearningExperimentTemplateParams,
    ...
    def setup_controller(self, topology: Union[GradualLearningTopology, TrainTestSwitchable],
                         ...
                         run_measurement_manager: RunMeasurementManager):
        controller.register(GradualLearningExperimentComponent(
            topology,
